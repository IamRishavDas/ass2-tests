...
public class PasswordlessAuthenticationApplicationDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public PasswordlessAuthenticationApplicationDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
