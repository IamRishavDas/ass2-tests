...
public static class PasswordlessAuthenticationApplicationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PasswordlessAuthenticationApplicationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
