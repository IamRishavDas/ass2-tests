...
namespace PasswordlessAuthenticationApplication.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("PasswordlessAuthenticationApplication") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "PasswordlessAuthenticationApplication", DisplayName = "PasswordlessAuthenticationApplication API", Resources = { "PasswordlessAuthenticationApplication" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["PasswordlessAuthenticationApplication_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["PasswordlessAuthenticationApplication_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["PasswordlessAuthenticationApplication_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["PasswordlessAuthenticationApplication_Swagger:RootUrl"]?.TrimEnd('/');
