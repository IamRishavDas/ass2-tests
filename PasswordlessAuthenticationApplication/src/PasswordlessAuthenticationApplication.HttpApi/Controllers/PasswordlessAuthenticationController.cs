...
using PasswordlessAuthenticationApplication.Identity;
using System;
...
namespace PasswordlessAuthenticationApplication.Controllers
{
    ...
    class PasswordlessAuthenticationController: ControllerBase
    {
        private readonly PasswordlessTokenProvider _passwordlessTokenProvider;
        private readonly IIdentityUserRepository _identityUserRepository;
        private readonly IEmailSender _emailSender;

        public PasswordlessAuthenticationController(PasswordlessTokenProvider passwordlessTokenProvider, IIdentityUserRepository identityUserRepository, IEmailSender emailSender)
        {
