...
public class PasswordlessAuthAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public PasswordlessAuthAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
