...
public static class PasswordlessAuthAppEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PasswordlessAuthAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
